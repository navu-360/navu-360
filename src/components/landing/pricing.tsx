        ...
        >
          <div className="relative mx-auto max-w-4xl lg:flex">
            <motion.div
              ...
              className="shadowAroundFeature featureThreeGradient disable-mobile-animation relative mx-auto mb-3 w-full min-w-[250px] rounded-md px-4 py-8 text-white md:max-w-[300px] lg:my-2 lg:flex lg:w-1/3 lg:max-w-none lg:flex-col lg:px-4 lg:py-10"
            >
