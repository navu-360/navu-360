  ...
  return (
    <main className="flex h-screen min-h-screen w-full flex-col pt-[100px]">
      <Header
        ...
        description="Uncover the key principles of developing leaders at all levels, ensuring your organization has a robust leadership pipeline"
        image="https://res.cloudinary.com/dpnbddror/image/upload/c_limit,w_400/v1699092208/navu/blog/blog8_wn8gsm.jpg"
      />
      <NavBar />
