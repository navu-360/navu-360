  ...
  return (
    <main className="flex h-screen min-h-screen w-full flex-col pt-[100px]">
      <Header
        ...
        description="Dive into the world of microlearning and discover how bite-sized, on-the-go training modules can lead to more engaged and skilled employees."
        image="https://res.cloudinary.com/dpnbddror/image/upload/c_limit,w_400/v1699092202/navu/blog/blog7_mdkbdv.jpg"
      />
      <NavBar />
