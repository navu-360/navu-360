    ...
    <>
      ...
      <main className="min-h-screen w-full bg-white pb-16">
        <div className="relative overflow-hidden pt-[5.75rem]">
          ...
          <div className="relative px-4 text-left sm:px-6 lg:px-8">
            <div className="policy mx-auto max-w-[40rem] text-sm font-medium text-slate-900">
              <p>
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Navu360, 4658,
                    Nairobi.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Navu360, accessible from{" "}
                    <a
                      href="navu360"
              ...
              <ul>
                <li>
                  <p>By email: business@navu360.com</p>
                </li>
              </ul>
            </div>
          </div>
