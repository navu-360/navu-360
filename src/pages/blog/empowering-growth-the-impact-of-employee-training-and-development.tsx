  ...
  return (
    <main className="flex h-screen min-h-screen w-full flex-col pt-[100px]">
      <Header
        ...
        description="Learn how data analytics can help organizations measure the impact of their training programs, leading to better decision-making and higher returns on investment."
        image="https://res.cloudinary.com/dpnbddror/image/upload/c_limit,w_400/v1699092197/navu/blog/blog9_sofstb.jpg"
      />
      <NavBar />
