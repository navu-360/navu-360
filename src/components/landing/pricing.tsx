...
export default function Pricing({
  ...
  return (
    <section
      id="pricing"
      className="mx-auto relative my-16 w-full px-4 py-10 text-gray-600"
    >
        ...
        >
          <div className="relative mx-auto max-w-4xl lg:flex">
            <motion.div
              ...
              className="shadowAroundFeature featureThreeGradient disable-mobile-animation relative mx-auto mb-3 w-full min-w-[250px] md:max-w-[300px] rounded-md px-4 py-8 text-white lg:my-2 lg:flex lg:w-1/3 lg:max-w-none lg:flex-col lg:px-4 lg:py-10"
            >
            ...
            <motion.div
              ...
              viewport={{ amount: 0.9, once: true }}
              className="shadowAroundFeature featureThreeGradient disable-mobile-animation mx-auto mb-3 w-full min-w-[300px] md:max-w-[300px] rounded-md px-8 py-8 text-white lg:relative lg:z-10 lg:-mx-3 lg:mb-0 lg:flex lg:w-1/3 lg:max-w-none lg:flex-col lg:px-10 lg:py-10"
            >
              <div className="w-full flex-grow">
                <h3
                  className={`mb-4 text-center font-bold uppercase ${font.className}`}
            ...
            <motion.div
              ...
              viewport={{ amount: 0.9, once: true }}
              className="shadowAroundFeature featureThreeGradient disable-mobile-animation mx-auto mb-3 w-full min-w-[300px] md:max-w-[300px] rounded-md px-8 py-8 text-white lg:my-2 lg:flex lg:w-1/3 lg:max-w-none lg:flex-col lg:px-10 lg:py-10"
            >
              <div className="w-full flex-grow">
                <h3
                  className={`mb-4 text-center font-bold uppercase ${font.className}`}
